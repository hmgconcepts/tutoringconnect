/* ====================================================================
   pwa-install.js — Tutoring Connect Gen v7
...
const PWAInstall = {
  ...
  init() {
    ...
    if (localStorage.getItem('tc_pwa_installed') === '1') this.installed = true;
  ...
  dismiss() {
    this.hideBanner();
    localStorage.setItem('tc_pwa_dismissed_at', Date.now().toString());
  },

  neverShow() {
    this.hideBanner();
    localStorage.setItem('tc_pwa_never', '1');
  },
  ...
  showIOSHelp() {
    openModal('Install on iPhone / iPad', `
      <div style="text-align:center;padding:12px 0">
        ...
        <p style="margin-top:16px;color:var(--gray-600);font-size:0.88rem">The app will appear on your home screen with the studio logo. It works offline and sends push notifications.</p>
      </div>
    `);
  }
};
...
console.log('%c[Tutoring Connect Gen v7] PWA install enforcement ready.', 'color:#06b6d4;font-weight:bold');
