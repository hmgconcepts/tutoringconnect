...
(function (w) {
  ...
  const MODULES = [
    ...
    { id: 'class_deck', name: 'ADEWALE CLASSROOM DECK', group: 'Sessions', file: 'class-deck.html', desc: 'Integrated HMG ADEWALE CLASSROOM DECK: split-screen teach, live classroom, Meet companion, student join, toolkit. No AI API.', flag: 'new' },
