...
-- #############################################################################
-- #   V40 — ANONYMOUS WRITE + VISIBILITY HARDENING  (appended 29 Aug 2026)    #
-- #   Closes two live-verified anonymous data leaks plus an anonymous write   #
-- #   path. Full evidence and a verification block are in                     #
-- #   database/v40-anon-write-and-visibility-hardening.sql                    #
-- #   MUST stay last: it supersedes the role-less notifications_own_read,     #
-- #   forum_read / forum_thread_write / forum_post_write and                  #
-- #   login_audit_self_insert policies defined earlier in this file.          #
-- #############################################################################
